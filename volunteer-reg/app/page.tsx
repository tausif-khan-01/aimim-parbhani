      ...
      <main className="container mx-auto px-4 py-8">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Join AIMIM Parbhani as a volunteer and help us strengthen our
            community. Fill out the form below to register and connect with your
            local Taluka group.
          </p>
        </div>
      ...
      <footer className="bg-green-700 text-white py-8 mt-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-green-100">
            All India Majlis-e-Ittehadul Muslimeen - Working for the Community
          </p>
        </div>
      </footer>
    </div>
